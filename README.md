# Basic-Physics-Data-Analysis

A modular command-line tool written in C and Python for basic statistical analysis of experimental physics data.
...
You must have Python installed. Run the following command in your terminal to execute the program:
